...
if __name__ == "__main__":
    ...
    plot_detections_histogram(df_original, df_attacked_318)
    plot_confidence_histogram(df_original, df_attacked_318)

    smooth_and_plot_confidence(df_original, df_attacked_318, window_size=10,
                               output_path='output_plots/confidence_scores_comparison.png')
    ...
    plot_number_of_detections_per_frame(df_original, df_attacked_318,
                                        output_path='output_plots/number_of_detections_per_frame.png')
